...
class News extends Component{
  render(){
    ...
    return (
      <div className="News">
        <header className="s-bg-panel-title s-b-default s-secondary">{LConfig['TITLE']}</header>
        <section>
          <header>
            <b></b>
            <div>
              <h1 className="s-link">高念书定调亚信软件2018：“三新四能” ···</h1>
          ...
          <ul className="s-b-default s-default">
